...
#+BEGIN_SRC emacs-lisp :tangle yes
  (setq
   ...
   visible-bell 1                                   ; Emacs flashes de screen
   ...
   user-full-name "Arthur Bailão"                   ; Set the full name of the current user
   user-mail-address "arthurbailao@gmail.com"       ; Set the the email address of the current user
...
Using Fira Code with ligatures
...
** COMMENT Matching Titlebar color on MacOS
...
Configuring icons-in-terminal
#+BEGIN_SRC emacs-lisp :tangle yes
  (add-to-list 'load-path (expand-file-name "icons-in-terminal/build/icons-in-terminal.el" user-emacs-directory))
...
** COMMENT Files Frequently Consulted
